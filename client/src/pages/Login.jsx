    ...
    return (
        <div className="min-h-screen bg-[#0f172a] flex items-center justify-center p-4 sm:p-6">
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                <div className="absolute top-[20%] left-[10%] sm:left-[20%] w-48 sm:w-72 h-48 sm:h-72 bg-indigo-600 rounded-full mix-blend-multiply filter blur-[80px] sm:blur-[128px] opacity-20 animate-blob"></div>
                <div className="absolute bottom-[20%] right-[10%] sm:right-[20%] w-48 sm:w-72 h-48 sm:h-72 bg-purple-600 rounded-full mix-blend-multiply filter blur-[80px] sm:blur-[128px] opacity-20 animate-blob animation-delay-2000"></div>
            </div>

            <div className="max-w-md w-full bg-[#1e293b] p-6 sm:p-8 rounded-2xl shadow-2xl border border-gray-700 relative z-10">
                <div className="text-center mb-6 sm:mb-8">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-indigo-600 rounded-xl flex items-center justify-center text-white font-bold text-xl sm:text-2xl mx-auto mb-3 sm:mb-4 shadow-lg shadow-indigo-500/30">
                        S
                    </div>
                    <h2 className="text-2xl sm:text-3xl font-bold text-white mb-1.5 sm:mb-2">Welcome Back</h2>
                    <p className="text-xs sm:text-sm text-gray-400">Sign in to continue to Synchro-AI</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                    ...
                    <div>
                        <div className="flex items-center justify-between mb-1.5">
                            ...
                            <Link to="/forgot-password" className="text-[10px] sm:text-xs text-indigo-400 hover:text-indigo-300">Forgot password?</Link>
                        </div>
                        <div className="relative">
                            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-500">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-2 sm:py-2.5 rounded-lg text-sm sm:text-base font-medium transition-all duration-200 flex items-center justify-center gap-2 shadow-lg shadow-indigo-900/20 disabled:opacity-70 disabled:cursor-not-allowed"
                    >
                        {loading ? 'Signing in...' : (
